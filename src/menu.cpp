...
//Dibujar("../assets/Sprites/Pruebas/Sprite-0005.png", 30, 30, -22, 50, 50);
	...
	Dibujar("../assets/Sprites/Pruebas/aaa1.png", 0, 0, 0, 160, 90); // fondo

	for (int i = 0; i < 6; i++)
	{

		titulo[i].altura = 55 + 5 * sin(angulo + i/2.0);
		titulo[i].horiz = 18 * i;
		...
		Dibujar("../assets/Sprites/menu/paloma.png", 28 + titulo[0].horiz, titulo[0].altura + 19, -2, 8, 8); // paloma
	}
